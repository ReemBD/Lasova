  ...
  return (
    <Modal open={open} onClose={() => setOpen(false)}>
      <Box className="new_group_modal">
        <button className="new_group_close-button" onClick={() => setOpen(false)} type="button" />
          ...
          <div className="new_group_block">
            ...
            <div className="new_group_form-block__between">
              <div className="new_group_form-block">
                <label htmlFor="name">
                  <input className="input" type="text" placeholder="שם" name="name" onChange={handleChange} />
                </label>
              ...
              <div className="new_group_form-block" style={{ marginLeft: '18%' }}>
                <label htmlFor="city">
                  <input className="input" placeholder="עיר" type="text" name="city" onChange={handleChange} />
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="new_group_block">
            ...
            <div className="new_group_form-block">
              <label htmlFor="contactName">
                <input type="text" className="input" name="contactName" placeholder="שם" onChange={handleChange} />
              </label>
              <label htmlFor="contactRole">
                <input type="text" className="input" name="contactRole" placeholder="תפקיד" onChange={handleChange} />
              </label>
              ...
              <label htmlFor="contactEmail">
                <input type="email" className="input" name="contactEmail" placeholder="מייל" onChange={handleChange} />
              </label>
            </div>
          </div>
            ...
            <div className="new_group_form-block__between">
              ...
              <div className="new_group_form-block">
                <label htmlFor="association">
                  <input className="input" placeholder="העדפת מסגרת 1" type="text" name="association" />
                </label>
                <label htmlFor="association-one">
                  <input className="input" placeholder="העדפת מסגרת 2" type="text" name="association-one" />
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="new_group_block">
            ...
            <div className="new_group_form-block">
              <label htmlFor="placement">
                <input className="input" placeholder="שיבוץ" type="text" name="placement" />
              </label>
              <label htmlFor="placementManager">
                <input className="input" placeholder="מנהל מסגרת" type="text" name="placementManager" />
              </label>
            </div>
          </div>
          <div className="new_group_block">
            ...
            <div className="new_group_form-block">
              <label htmlFor="comments">
                <textarea className="input" placeholder="הערות נוספות" type="text" name="comments" />
              </label>
            </div>
          </div>
          <Button variant="contained" type="submit" className="new_group_modal_btn">
            שמירה
          </Button>
        </form>
      </Box>
